...
<Window
    ...
    Title="Universal PC Optimizer v15.5"
        ...
        <ScrollViewer Grid.Row="0" VerticalScrollBarVisibility="Auto">
          <StackPanel x:Name="StepPanel">
            ...
            <Border x:Name="Step0" CornerRadius="6" Margin="0,2" Padding="12,8" Background="#080A18">
              <Grid><Grid.ColumnDefinitions><ColumnDefinition Width="30"/><ColumnDefinition Width="*"/><ColumnDefinition Width="78"/></Grid.ColumnDefinitions>
                <TextBlock x:Name="Icon0" Text="○" Foreground="#243040" FontSize="17" VerticalAlignment="Center"/>
                <TextBlock x:Name="Lbl0" Grid.Column="1" Text="Drive Optimization (TRIM)" Foreground="#304858" FontSize="14" VerticalAlignment="Center"/>
                <TextBlock x:Name="Tag0" Grid.Column="2" Text="PENDING" Foreground="#1E2C3A" FontSize="10" HorizontalAlignment="Right" VerticalAlignment="Center" FontFamily="Segoe UI Mono"/>
              </Grid></Border>

            <Border x:Name="Step1" CornerRadius="6" Margin="0,2" Padding="12,8" Background="#080A18">
              <Grid><Grid.ColumnDefinitions><ColumnDefinition Width="30"/><ColumnDefinition Width="*"/><ColumnDefinition Width="78"/></Grid.ColumnDefinitions>
                <TextBlock x:Name="Icon1" Text="○" Foreground="#243040" FontSize="17" VerticalAlignment="Center"/>
                <TextBlock x:Name="Lbl1" Grid.Column="1" Text="Performance Tweaks" Foreground="#304858" FontSize="14" VerticalAlignment="Center"/>
                <TextBlock x:Name="Tag1" Grid.Column="2" Text="PENDING" Foreground="#1E2C3A" FontSize="10" HorizontalAlignment="Right" VerticalAlignment="Center" FontFamily="Segoe UI Mono"/>
              </Grid></Border>

            <Border x:Name="Step2" CornerRadius="6" Margin="0,2" Padding="12,8" Background="#080A18">
              <Grid><Grid.ColumnDefinitions><ColumnDefinition Width="30"/><ColumnDefinition Width="*"/><ColumnDefinition Width="78"/></Grid.ColumnDefinitions>
                <TextBlock x:Name="Icon2" Text="○" Foreground="#243040" FontSize="17" VerticalAlignment="Center"/>
                <TextBlock x:Name="Lbl2" Grid.Column="1" Text="Privacy &amp; Telemetry" Foreground="#304858" FontSize="14" VerticalAlignment="Center"/>
                <TextBlock x:Name="Tag2" Grid.Column="2" Text="PENDING" Foreground="#1E2C3A" FontSize="10" HorizontalAlignment="Right" VerticalAlignment="Center" FontFamily="Segoe UI Mono"/>
              </Grid></Border>

            <Border x:Name="Step3" CornerRadius="6" Margin="0,2" Padding="12,8" Background="#080A18">
              <Grid><Grid.ColumnDefinitions><ColumnDefinition Width="30"/><ColumnDefinition Width="*"/><ColumnDefinition Width="78"/></Grid.ColumnDefinitions>
                <TextBlock x:Name="Icon3" Text="○" Foreground="#243040" FontSize="17" VerticalAlignment="Center"/>
                <TextBlock x:Name="Lbl3" Grid.Column="1" Text="Memory &amp; CPU Tuning" Foreground="#304858" FontSize="14" VerticalAlignment="Center"/>
                <TextBlock x:Name="Tag3" Grid.Column="2" Text="PENDING" Foreground="#1E2C3A" FontSize="10" HorizontalAlignment="Right" VerticalAlignment="Center" FontFamily="Segoe UI Mono"/>
              </Grid></Border>

            <Border x:Name="Step4" CornerRadius="6" Margin="0,2" Padding="12,8" Background="#080A18">
              <Grid><Grid.ColumnDefinitions><ColumnDefinition Width="30"/><ColumnDefinition Width="*"/><ColumnDefinition Width="78"/></Grid.ColumnDefinitions>
                <TextBlock x:Name="Icon4" Text="○" Foreground="#243040" FontSize="17" VerticalAlignment="Center"/>
                <TextBlock x:Name="Lbl4" Grid.Column="1" Text="Network Optimization" Foreground="#304858" FontSize="14" VerticalAlignment="Center"/>
                <TextBlock x:Name="Tag4" Grid.Column="2" Text="PENDING" Foreground="#1E2C3A" FontSize="10" HorizontalAlignment="Right" VerticalAlignment="Center" FontFamily="Segoe UI Mono"/>
              </Grid></Border>

            <Border x:Name="Step5" CornerRadius="6" Margin="0,2" Padding="12,8" Background="#080A18">
              <Grid><Grid.ColumnDefinitions><ColumnDefinition Width="30"/><ColumnDefinition Width="*"/><ColumnDefinition Width="78"/></Grid.ColumnDefinitions>
                <TextBlock x:Name="Icon5" Text="○" Foreground="#243040" FontSize="17" VerticalAlignment="Center"/>
                <TextBlock x:Name="Lbl5" Grid.Column="1" Text="Startup, DNS &amp; Disk Cleanup" Foreground="#304858" FontSize="14" VerticalAlignment="Center"/>
                <TextBlock x:Name="Tag5" Grid.Column="2" Text="PENDING" Foreground="#1E2C3A" FontSize="10" HorizontalAlignment="Right" VerticalAlignment="Center" FontFamily="Segoe UI Mono"/>
              </Grid></Border>
